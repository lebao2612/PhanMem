...
const SuggestedTopicsPopup = ({
  ...
  return (
    <div
      ref={popupRef}
      className="fixed z-50 bg-zinc-800 text-sm text-zinc-200 border border-zinc-700 rounded-md shadow-lg p-4"
      style={{
    ...
    >
      {isLoading ? (
        ...
        <div className="text-zinc-400 italic">No suggested topics.</div>
      )}
    </div>
  );
};

export default SuggestedTopicsPopup;
