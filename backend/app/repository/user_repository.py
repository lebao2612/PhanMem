...
class UserRepository:
    ...
    def is_email_taken(email: str) -> bool:
        try:
            ...
            raise HandledException(f"Lỗi kiểm tra email đã tồn tại: {e}", 500)
    ...
    def create_user_with_email(email: str, password: str, name: str) -> User:
        try:
            ...
            raise HandledException(f"Tạo user thất bại: {e}", 400)
    ...
    def change_password(user: User, new_password: str) -> None:
        try:
            ...
            raise HandledException(f"Đổi mật khẩu thất bại: {e}", 400)
